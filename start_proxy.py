...
# Default values
DEFAULT_URL_MAPPINGS_FILE = "url_mappings.json"
...
def main():
    ...
    Options:
      -m FILE, --url-mappings-file FILE
                            Set the URL mappings file (default: {DEFAULT_URL_MAPPINGS_FILE})    
    ...
    parser = argparse.ArgumentParser(
        description="Start mitmproxy with a special TR-069 rewrite script",
        usage=usage,
        add_help=False,
    )
    parser.add_argument(
        "-m",
        "--url-mappings-file",
        default=DEFAULT_URL_MAPPINGS_FILE,
        help=f"Set the URL mappings file (default: {DEFAULT_URL_MAPPINGS_FILE})",
    )
    parser.add_argument(
        "-o",
    ...
    os.environ["URL_MAPPINGS_FILE"] = args.url_mappings_file
